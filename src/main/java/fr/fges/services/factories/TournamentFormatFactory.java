...
public class TournamentFormatFactory {
    public static List<TournamentFormat> create() {
        List<TournamentFormat> tournamentFormats = new ArrayList<>();
        tournamentFormats.add(new ChampionshipFormat("Championship (everyone plays everyone)"));
        tournamentFormats.add(new KingOfTheHillFormat("King of the Hill (winner stays)"));
